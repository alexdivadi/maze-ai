...
class Visualizer(object):
    ...
    def show_maze(self):
        ...
        self.ax.set_title("Generated Maze")
    ...
    def show_maze_solution(self):
        ...
        for i in range(1, self.maze.solution_path.__len__()):
            if self.maze.solution_path[i][0] not in list_of_backtrackers and\
                ...
                circle_num += 1
                fc = ((1, 0, 0) if self.maze.optimal_path and self.maze.solution_path[i] in self.maze.optimal_path else
                    (0, circle_num/(len(self.maze.solution_path) - 2*len(list_of_backtrackers)), 0))
        ...
        self.ax.set_title(f"{self.media_filename}; Cost: {self.maze.optimal_path_cost}; Steps: {self.maze.solution_path.__len__()}")
